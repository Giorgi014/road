...
export const ProductCard = ({
  ...
  return (
    ...
    >
      {isNew && (
        <div className="flex justify-center items-center absolute top-4 right-4 z-10 rounded-full bg-[image:var(--pill-grad)] px-3 py-1 shadow-[0_0_20px_-4px_var(--violet)]">
